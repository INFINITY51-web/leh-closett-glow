...
type HomeSection = { id: string; title: string; type: "Categoria" | "Destaques" | "Mais vendidos" | "Produtos"; active: boolean; sort_order: number; category_id?: string; product_ids?: string[] }; 

function HomeSectionsEditor() {
  const blank: Omit<HomeSection, "id"> = { title: "", type: "Destaques", active: true, sort_order: 0, category_id: "", product_ids: [] };
