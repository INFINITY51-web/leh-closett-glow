...
type HomeSection = { id: string; title: string; type: "Categoria" | "Destaques" | "Mais vendidos" | "Produtos"; active: boolean; sort_order: number };

function HomeSectionsEditor() {
  const blank: Omit<HomeSection, "id"> = { title: "", type: "Destaques", active: true, sort_order: 0 };
