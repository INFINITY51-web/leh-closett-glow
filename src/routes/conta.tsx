...
import { formatCpf, isValidCpf, updateProfile, type Profile } from "../lib/customer-account";
  ...
  useEffect(() => {
    ...
    async function loadAccount() {
      try {
        ...
        setEmail(user.email ?? "");
        setForm({ full_name: loadedProfile?.full_name?.trim() || authName, cpf: formatCpf(loadedProfile?.cpf ?? ""), phone: loadedProfile?.phone ?? "" });
      } catch (error) {
