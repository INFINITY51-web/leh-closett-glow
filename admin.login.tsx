...
function AdminLogin() {
  ...
  async function handleSubmit(event: FormEvent<HTMLFormElement>) {
    ...
    setError("");
    setLoading(true);
    try { await signInAdmin(email, password); await navigate({ to: "/admin" }); } catch (reason) { setError(reason instanceof Error ? reason.message : "Não foi possível autenticar."); } finally { setLoading(false); }
  }
